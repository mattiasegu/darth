...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root +
        'discrete/videos/train/front/det_2d_cocofmt_fixed.json',
        img_prefix=data_root + 'discrete/videos/train/front/img/',
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root +
            'discrete/videos/val/front/det_2d_cocofmt_fixed.json',
        img_prefix=data_root + 'discrete/videos/val/front/img/',
